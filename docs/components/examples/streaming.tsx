...
export default () => {
  ...
  const [platform, setPlatform] = useState<'auto' | 'openai' | 'dify' | 'bailian'>('auto');

  const [optimizeConfig, setOptimizeConfig] = useState<OptimizeConfig | undefined>(undefined);
  ...
  return (
    <DemoWrapper height="600px" title="Streaming Output Test">
      <div style={{ padding: '12px 16px', borderBottom: '1px solid #e4e4e7', backgroundColor: '#f9fafb' }}>
        <Space direction="vertical" size="small" style={{ width: '100%' }}>
          <div style={{ fontSize: '14px', color: '#52525b', marginBottom: 8 }}>
